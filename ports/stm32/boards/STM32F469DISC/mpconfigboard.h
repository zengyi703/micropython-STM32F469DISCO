...
// SPI busses
#define MICROPY_HW_SPI2_NSS     (pin_H6)
...
// LEDs
#define MICROPY_HW_LED1             (pin_G6)//(pin_D5) // red
#define MICROPY_HW_LED2             (pin_D4) // green
#define MICROPY_HW_LED3             (pin_D5)//)(pin_K3) // blue
#define MICROPY_HW_LED4             (pin_K3)//(pin_D4) // orange
...
// SDRAM
#define MICROPY_HW_SDRAM_SIZE  (128 / 8 * 1024 * 1024)  // 64 Mbit
